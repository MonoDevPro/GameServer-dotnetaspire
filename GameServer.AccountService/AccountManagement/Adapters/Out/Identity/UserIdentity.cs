...
namespace GameServer.AccountService.Service.Definitions.Authorization;
...
public sealed class UserIdentity
{
    ...
    public IIdentity? User
    {
        get
        {
            ...
            throw new Exception($"{nameof(UserIdentity)} has not been initialized. Please use {nameof(UserIdentity)}.Instance.Configure(...) in Configure Application method in Startup.cs");
        }
    }
